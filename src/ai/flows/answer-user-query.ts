...
- Use 'findFaq' to answer general questions.
...
Prioritize using the tools over your own general knowledge. If the tools return relevant information, use that information to construct your answer.
